...
def evaluate(theta_fun:np.ndarray,grad_flag:bool =False):    
    ...
    design1 = solution.matching_gcheb_from_functions(hmrf1.matfun,hmrf1.rhsfun)
    design2 = solution.matching_gcheb_from_functions(hmrf2.matfun,hmrf2.rhsfun)
    ...
    adjoint = adjoint_method.get_adjoint(solution,gss,dldedge)
